...
class InstancesFromHuggingFace(BaseModel, AbstractInstanceSource):
    ...
    def get_instance_configs(self) -> list[BatchInstance]:
        ...
        ds: list[dict[str, Any]] = load_dataset(self.dataset_name, split=self.split,token="") 
        ...
        instances = [
            instance.to_full_batch_instance(self.deployment) for instance in simple_instances
            ]
